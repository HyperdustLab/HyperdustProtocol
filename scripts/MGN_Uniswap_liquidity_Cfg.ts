...
async function main() {
  const contractFactory = await ethers.getContractFactory("MGN_Uniswap_liquidity_Cfg");
  ...
  setTimeout(async () => {
    await run("verify:verify", {
      ...
      contract: "contracts/space/MGN_Uniswap_liquidity_Cfg.sol:MGN_Uniswap_liquidity_Cfg",
