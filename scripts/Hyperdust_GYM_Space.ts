...
async function main() {
  ...
  const contract = await ethers.getContractFactory('Hyperdust_GYM_Space')
  ...
  await (await instance.setContractAddress(['0x9D88106Ba510D3852eC03B22b8F754F2bcd16739', Hyperdust_Storage.target])).wait()
